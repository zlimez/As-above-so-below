...
#pragma warning restore 0414
        ...
        public void UpdatePhase1(float deltaTime)
        {
            ...
            #endregion Handle Move Position
            ...
            if (_solveMovementCollisions)
            {
                ...
                #endregion Resolve initial overlaps
            }
            ...
            #endregion Ground Probing and Snapping
            ...
            if (InteractiveRigidbodyHandling)
            {
                ...
                #endregion Interactive Rigidbody Handling
            }
        }
        ...
        public void UpdatePhase2(float deltaTime)
        {
            ...
            if (_solveMovementCollisions && InteractiveRigidbodyHandling)
            {
                if (InteractiveRigidbodyHandling)
                {
                    ...
                    #endregion Solve potential attached rigidbody overlap
                }
                ...
                if (InteractiveRigidbodyHandling)
                {
                    ...
                    #endregion Resolve overlaps that could've been caused by rotation or physics movers simulation pushing the character
                }
            }
            ...
            #endregion Calculate Character movement from base velocity
