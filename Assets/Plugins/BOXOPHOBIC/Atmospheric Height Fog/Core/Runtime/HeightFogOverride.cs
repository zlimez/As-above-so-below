...
namespace AtmosphericHeightFog
{
    ...
    public class HeightFogOverride : StyledMonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (volumeTrigger == null || globalFog == null)
            {
                return;
            }
            ...
            Vector3 triggerPos = volumeTrigger.position;
            Vector3 closestPos = volumeCollider.ClosestPoint(triggerPos);

            float dist = Vector3.Distance(triggerPos, closestPos);
        ...
        void GetMainTrigger()
        {
            ...
            {
                volumeTrigger = Camera.main.transform;
            }
        }
