	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float mulTime5_g22 = _Time.y * _TimeScale;
				float mulTime7_g22 = _Time.y * _TimeFrequency;
				#if defined(_TIMESETTINGS_LINEAR_DEFAULT)
				float staticSwitch1_g22 = _Time.y;
				#elif defined(_TIMESETTINGS_LINEAR_SCALED)
				float staticSwitch1_g22 = mulTime5_g22;
				#elif defined(_TIMESETTINGS_LINEAR_FPS)
				float staticSwitch1_g22 = ( _TimeScale * ( floor( ( _Time.y * _TimeFPS ) ) / _TimeFPS ) );
				...
				float staticSwitch1_g22 = ( ( _TimeRange * sin( ( _TimeFrequency * ( floor( ( _TimeFPS * _Time.y ) ) / _TimeFPS ) ) ) ) + 100.0 );
				#elif defined(_TIMESETTINGS_CUSTOM_VALUE)
				float staticSwitch1_g22 = _TimeValue;
				#else
				float staticSwitch1_g22 = _Time.y;
				#endif
				float temp_output_30_0_g10 = staticSwitch1_g22;
				float3 rotatedValue21_g10 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g10 * _VibrateRotation ) );
				
				
				IN.vertex.xyz += float3( ( ( sin( ( _VibrateFrequency * temp_output_30_0_g10 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g10).xy ) + float2( 0,0 ) ) ,  0.0 ); 
...
/*ASEBEGIN
Version=18900
0;0;1920;1019;2108.813;657.5809;1.924767;True;True
...
Node;AmplifyShaderEditor.FunctionNode;28;-505.4818,141.1975;Inherit;False;ShaderTime;0;;22;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;27;-244.5639,168.9735;Inherit;False;_Vibrate;7;;10;490530af17c72da419bbc3bea4bae9b4;0;2;30;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;11.89928,-9.891866;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;8;Sprite Shaders Ultimate/Standard/Transform/Vibrate;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;False;True;3;1;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
WireConnection;17;0;26;0
WireConnection;15;1;17;0
WireConnection;27;30;28;0
WireConnection;14;0;15;0
WireConnection;14;1;27;0
ASEEND*/
//CHKSM=332355EEBE2FC2D1A65C40B5E83977FCAACD9897