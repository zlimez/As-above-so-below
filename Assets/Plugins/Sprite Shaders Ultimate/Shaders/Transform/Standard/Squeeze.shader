...
Shader "Sprite Shaders Ultimate/Standard/Transform/Squeeze"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 texCoord2_g122 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g122 = texCoord2_g122;
				
				fixed4 c = ( tex2D( _MainTex, ( temp_output_1_0_g122 + ( ( temp_output_1_0_g122 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g122 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) ) ) * IN.color );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18800
0;399;1338;620;1693.959;382.2274;1.481986;True;True
...
Node;AmplifyShaderEditor.FunctionNode;77;-1065.816,6.768036;Inherit;False;_Squeeze;0;;122;828fb82332d5dab4a9b2cfe1db09526d;0;1;1;FLOAT2;0,0;False;1;FLOAT2;0
