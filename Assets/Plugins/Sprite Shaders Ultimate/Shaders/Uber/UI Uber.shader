...
Shader "Sprite Shaders Ultimate/Uber/UI Uber"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				#ifdef _ENABLESQUISH2_ON
				float2 texCoord83_g4149 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break77_g4149 = texCoord83_g4149;
				float2 appendResult72_g4149 = (float2(( _SquishStretch * ( break77_g4149.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g4149.y + _SquishFlip ) * -_SquishSquish )));
				float2 staticSwitch198 = ( appendResult72_g4149 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g4173 = staticSwitch198;
				...
				float temp_output_8_0_g4173 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g4173 = ( ( sin( ( temp_output_8_0_g4173 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g4173 );
				#else
				float2 staticSwitch4_g4173 = temp_output_2_0_g4173;
				#endif
				#ifdef _ENABLEVIBRATE_ON
				float temp_output_30_0_g4175 = temp_output_8_0_g4173;
				float3 rotatedValue21_g4175 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g4175 * _VibrateRotation ) );
				float2 staticSwitch6_g4173 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g4175 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g4175).xy ) + staticSwitch4_g4173 );
				#else
				float2 staticSwitch6_g4173 = staticSwitch4_g4173;
				#endif
				float2 temp_output_250_0 = staticSwitch6_g4173;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				#endif
				float4 temp_output_1_0_g4150 = staticSwitch75;
				float4 temp_output_1_0_g4151 = temp_output_1_0_g4150;
				float temp_output_53_0_g4151 = max( _FullAlphaDissolveWidth , 0.001 );
				float2 temp_output_18_0_g4150 = shaderPosition235;
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float clampResult17_g4151 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g4151 ) ) - tex2D( _UberNoiseTexture, ( temp_output_18_0_g4150 * _FullAlphaDissolveNoiseScale ) ).r ) / temp_output_53_0_g4151 ) , 0.0 , 1.0 );
				float4 appendResult3_g4151 = (float4((temp_output_1_0_g4151).rgb , ( temp_output_1_0_g4151.a * clampResult17_g4151 )));
				float4 staticSwitch3_g4150 = appendResult3_g4151;
				#else
				float4 staticSwitch3_g4150 = temp_output_1_0_g4150;
				#endif
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float temp_output_5_0_g4159 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g4150 * _FullGlowDissolveNoiseScale ) ).r;
				float temp_output_61_0_g4159 = step( temp_output_5_0_g4159 , _FullGlowDissolveFade );
				float temp_output_53_0_g4159 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g4159 = staticSwitch3_g4150;
				float4 appendResult3_g4159 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g4159 - step( temp_output_5_0_g4159 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g4159 ) ) - temp_output_53_0_g4159 ) ) ) ) + (temp_output_1_0_g4159).rgb ) , ( temp_output_1_0_g4159.a * temp_output_61_0_g4159 )));
				float4 staticSwitch5_g4150 = appendResult3_g4159;
				#else
				float4 staticSwitch5_g4150 = staticSwitch3_g4150;
				#endif
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 temp_output_1_0_g4161 = staticSwitch5_g4150;
				float2 temp_output_76_0_g4161 = temp_output_18_0_g4150;
				float clampResult17_g4161 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g4161 ) + ( tex2D( _UberNoiseTexture, ( temp_output_76_0_g4161 * _SourceAlphaDissolveNoiseScale ) ).r * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g4161 = (float4((temp_output_1_0_g4161).rgb , ( temp_output_1_0_g4161.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g4161 ) ):( clampResult17_g4161 )) )));
				float4 staticSwitch8_g4150 = appendResult3_g4161;
				#else
				float4 staticSwitch8_g4150 = staticSwitch5_g4150;
				#endif
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float2 temp_output_90_0_g4157 = temp_output_18_0_g4150;
				float temp_output_65_0_g4157 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g4157 ) + ( tex2D( _UberNoiseTexture, ( temp_output_90_0_g4157 * _SourceGlowDissolveNoiseScale ) ).r * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g4157 = step( temp_output_65_0_g4157 , _SourceGlowDissolveFade );
				float temp_output_76_0_g4157 = step( temp_output_65_0_g4157 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g4157 = staticSwitch8_g4150;
				float4 appendResult3_g4157 = (float4(( ( max( ( temp_output_75_0_g4157 - temp_output_76_0_g4157 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g4157).rgb ) , ( temp_output_1_0_g4157.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g4157 ) ):( temp_output_75_0_g4157 )) )));
				float4 staticSwitch9_g4150 = appendResult3_g4157;
				#else
				float4 staticSwitch9_g4150 = staticSwitch8_g4150;
				#endif
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 temp_output_1_0_g4153 = staticSwitch9_g4150;
				float2 temp_output_161_0_g4153 = temp_output_18_0_g4150;
				float3 rotatedValue136_g4153 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g4153 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g4153 = rotatedValue136_g4153;
				float clampResult154_g4153 = clamp( ( ( break130_g4153.x + break130_g4153.y + _DirectionalAlphaFadeFade + ( tex2D( _UberNoiseTexture, ( temp_output_161_0_g4153 * _DirectionalAlphaFadeNoiseScale ) ).r * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g4153 = (float4((temp_output_1_0_g4153).rgb , ( temp_output_1_0_g4153.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g4153 ) ):( clampResult154_g4153 )) )));
				float4 staticSwitch11_g4150 = appendResult3_g4153;
				#else
				float4 staticSwitch11_g4150 = staticSwitch9_g4150;
				#endif
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float2 temp_output_171_0_g4155 = temp_output_18_0_g4150;
				float3 rotatedValue136_g4155 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g4155 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g4155 = rotatedValue136_g4155;
				float temp_output_168_0_g4155 = max( ( ( break130_g4155.x + break130_g4155.y + _DirectionalGlowFadeFade + ( tex2D( _UberNoiseTexture, ( temp_output_171_0_g4155 * _DirectionalGlowFadeNoiseScale ) ).r * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g4155 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g4155 ) ):( temp_output_168_0_g4155 )) );
				float4 temp_output_1_0_g4155 = staticSwitch11_g4150;
				float clampResult154_g4155 = clamp( temp_output_161_0_g4155 , 0.0 , 1.0 );
				float4 appendResult3_g4155 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g4155 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g4155 ) ):( temp_output_168_0_g4155 )) ) ) ) + (temp_output_1_0_g4155).rgb ) , ( temp_output_1_0_g4155.a * clampResult154_g4155 )));
				float4 staticSwitch15_g4150 = appendResult3_g4155;
				#else
				float4 staticSwitch15_g4150 = staticSwitch11_g4150;
				#endif
				float4 temp_output_1_0_g4163 = staticSwitch15_g4150;
				float2 temp_output_126_0_g4163 = temp_output_18_0_g4150;
				float temp_output_121_0_g4163 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g4163 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g4164 = (float2(temp_output_121_0_g4163 , temp_output_121_0_g4163));
				float temp_output_17_0_g4164 = length( ( (( ( abs( temp_output_126_0_g4163 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g4164 ) );
				#ifdef _ENABLEHALFTONE_ON
				float clampResult17_g4163 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g4164 ) / fwidth( temp_output_17_0_g4164 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g4163 = (float4((temp_output_1_0_g4163).rgb , ( temp_output_1_0_g4163.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g4163 ) ):( clampResult17_g4163 )) )));
				float4 staticSwitch13_g4150 = appendResult3_g4163;
				#else
				float4 staticSwitch13_g4150 = staticSwitch15_g4150;
				#endif
				#ifdef _ENABLEADDCOLOR_ON
				float4 temp_output_1_0_g4166 = staticSwitch13_g4150;
				...
				#else
				float4 staticSwitch5_g4165 = staticSwitch13_g4150;
				#endif
				#ifdef _ENABLEALPHATINT_ON
...
/*ASEBEGIN
Version=18900
218;142;1413;636;-3234.535;-1156.215;2.135912;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;266;4591.907,1706.213;Inherit;False;235;shaderPosition;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;416;;4149;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;278;;4150;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;250;4759.72,401.6135;Inherit;False;_UberTransformOffset;392;;4173;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;195;4547.692,143.2021;Inherit;False;TintVertex;-1;;4176;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;262;5639.575,215.1301;Float;False;True;-1;2;SpriteShadersUltimate.UberShaderGUI;0;6;Sprite Shaders Ultimate/Uber/UI Uber;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;False;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;True;True;True;True;True;0;True;-9;False;False;False;False;False;False;False;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;0;True;-11;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;262;0;143;0
WireConnection;262;1;142;0
ASEEND*/
//CHKSM=4D7583230785E9B38D53D2D375CA1EEB09A33827
