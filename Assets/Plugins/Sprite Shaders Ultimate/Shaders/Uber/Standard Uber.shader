...
Shader "Sprite Shaders Ultimate/Uber/Standard Uber"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				#ifdef _ENABLESQUISH2_ON
				float2 texCoord83_g3993 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break77_g3993 = texCoord83_g3993;
				float2 appendResult72_g3993 = (float2(( _SquishStretch * ( break77_g3993.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g3993.y + _SquishFlip ) * -_SquishSquish )));
				float2 staticSwitch198 = ( appendResult72_g3993 + _ZeroVector );
				#else
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				#endif
				#ifdef _ENABLESINEROTATE_ON
				float3 rotatedValue36_g3898 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g3892 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g3892 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				float2 staticSwitch9_g3892 = (rotatedValue36_g3898).xy;
				#else
				float2 staticSwitch9_g3892 = staticSwitch7_g3892;
				#endif
				#ifdef _ENABLEUVROTATE_ON
				float3 rotatedValue8_g3899 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g3892 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g3892 * _UVRotateSpeed * UNITY_PI ) );
				...
				float clampResult28_g3907 = clamp( ( ( ( tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g3907 ) * temp_cast_11 ) ).r - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g3907 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				#ifdef _ENABLESMOKE_ON
				float3 lerpResult34_g3907 = lerp( ( (temp_output_1_0_g3907).rgb * (IN.color).rgb ) , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g3907 ) * _SmokeDarkEdge ));
				...
				float clampResult37_g3905 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g3905.r + ( tex2D( _UberNoiseTexture, ( temp_output_57_0_g3905 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g3905 = (float4(( float4( (IN.color).rgb , 0.0 ) * temp_output_1_0_g3905 ).rgb , ( temp_output_1_0_g3905.a * pow( clampResult37_g3905 , ( _CustomFadeSmoothness / max( tex2DNode3_g3905.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				...
				float2 appendResult4_g3910 = (float2(ase_worldPos.x , ase_worldPos.y));
				...
				float4 appendResult22_g3948 = (float4(( (_HologramTint).rgb * pow( saferPower7_g3950 , temp_output_9_0_g3950 ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g3948.a )));
				...
				float3 rotatedValue69_g3988 = RotateAroundAxis( float3( 0,0,0 ), float3( ( ( temp_output_40_0_g3955 * _ShineSpeed ) + ( _ShineScale * temp_output_41_0_g3955 ) ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 360.0 ) * UNITY_PI ) );
				...
				#else
				float4 staticSwitch8_g3904 = IN.color;
				#endif
				#ifdef _ENABLESMOKE_ON
...
/*ASEBEGIN
Version=18900
218;142;1413;636;-3326.324;-1428.394;1.945626;True;False
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;166;;3890;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;257;3382.41,-2373.518;Inherit;False;_UberTransformUV;354;;3892;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;120;-737.796,35.8288;Inherit;False;_UberCustomAlpha;435;;3904;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;COLOR;12;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;420;;3909;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;241;-136.8644,-329.1863;Inherit;False;_UberColor;39;;3913;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;140;;3948;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;160;;3951;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;245;1656.25,-345.9998;Inherit;False;_UberEffect;171;;3955;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;415;;3993;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;250;4759.72,401.6135;Inherit;False;_UberTransformOffset;391;;4018;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;5639.575,215.1301;Float;False;True;-1;2;SpriteShadersUltimate.UberShaderGUI;0;8;Sprite Shaders Ultimate/Uber/Standard Uber;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;False;True;3;1;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=A4A9124E4A254D64107DEDD252DB6B74089F0ADD
