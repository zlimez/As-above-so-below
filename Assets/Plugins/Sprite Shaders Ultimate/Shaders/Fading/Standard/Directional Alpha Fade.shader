...
Shader "Sprite Shaders Ultimate/Standard/Fading/Directional Alpha Fade"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_DirectionalAlphaFadeInvert("Directional Alpha Fade: Invert", Float) = 0
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 texCoord2_g235 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord22_g235 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float3 ase_worldPos = IN.ase_texcoord2.xyz;
				float2 texCoord23_g235 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult28_g235 = (float2(_RectWidth , _RectHeight));
				float4 screenPos = IN.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				#if defined(_SHADERSPACE_UV)
				float2 staticSwitch1_g235 = ( texCoord2_g235 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#elif defined(_SHADERSPACE_UV_RAW)
				float2 staticSwitch1_g235 = texCoord22_g235;
				#elif defined(_SHADERSPACE_OBJECT)
				float2 staticSwitch1_g235 = (IN.ase_texcoord1.xyz).xy;
				#elif defined(_SHADERSPACE_OBJECT_SCALED)
				float2 staticSwitch1_g235 = ( (IN.ase_texcoord1.xyz).xy * (ase_objectScale).xy );
				#elif defined(_SHADERSPACE_WORLD)
				float2 staticSwitch1_g235 = (ase_worldPos).xy;
				#elif defined(_SHADERSPACE_UI_ELEMENT)
				float2 staticSwitch1_g235 = ( texCoord23_g235 * ( appendResult28_g235 / _PixelsPerUnit ) );
				#elif defined(_SHADERSPACE_SCREEN)
				float2 staticSwitch1_g235 = ( ( (ase_screenPosNorm).xy * (_ScreenParams).xy ) / ( _ScreenParams.x / _ScreenWidthUnits ) );
				#else
				float2 staticSwitch1_g235 = ( texCoord2_g235 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float2 temp_output_161_0_g232 = staticSwitch1_g235;
				float3 rotatedValue136_g232 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g232 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g232 = rotatedValue136_g232;
				float clampResult154_g232 = clamp( ( ( break130_g232.x + break130_g232.y + _DirectionalAlphaFadeFade + ( tex2D( _DirectionalAlphaFadeNoiseTexture, ( temp_output_161_0_g232 * _DirectionalAlphaFadeNoiseScale ) ).r * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18900
42;115;1374;647;1303.675;374.0672;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;108;-733.675,-156.0672;Inherit;False;ShaderSpace;0;;235;be729ef05db9c224caec82a3516038dc;0;1;3;SAMPLER2D;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;107;-353.585,-131.5853;Inherit;False;_DirectionalAlphaFade;6;;232;65c65af0f3ba9814bae500501cf3b956;0;3;161;FLOAT2;0,0;False;160;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;87;73.8176,-123.5701;Inherit;False;TintVertex;-1;;234;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;108;3;41;0
WireConnection;107;161;108;0
WireConnection;107;1;17;0
WireConnection;87;1;107;0
WireConnection;14;0;87;0
ASEEND*/
//CHKSM=A91BE162E8AC63BE92986F44E37B19B622A3FEF2