...
Shader "Sprite Shaders Ultimate/Standard/Fading/Custom Fade"
{
	Properties
	{
		...
		_CustomFadeNoiseTexture("Custom Fade: Noise Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			uniform sampler2D _CustomFadeNoiseTexture;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 texCoord58_g74 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_57_0_g74 = texCoord58_g74;
				float4 tex2DNode3_g74 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g74 );
				float clampResult37_g74 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g74.r + ( tex2D( _CustomFadeNoiseTexture, ( temp_output_57_0_g74 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g74 = (float4(( float4( (IN.color).rgb , 0.0 ) * temp_output_1_0_g74 ).rgb , ( temp_output_1_0_g74.a * pow( clampResult37_g74 , ( _CustomFadeSmoothness / max( tex2DNode3_g74.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				
				fixed4 c = appendResult13_g74;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18800
72;437;1374;821;1009.768;506.9525;1.3;True;True
...
Node;AmplifyShaderEditor.FunctionNode;66;-235.6703,-107.7649;Inherit;False;_CustomFade;0;;74;09a17a2b3ff778e4baeae7d542f88dd6;0;3;57;FLOAT2;0,0;False;56;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;216.3043,-86.66556;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;8;Sprite Shaders Ultimate/Standard/Fading/Custom Fade;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;3;1;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;True;2;False;-1;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
WireConnection;17;0;41;0
WireConnection;66;1;17;0
WireConnection;14;0;66;0
ASEEND*/
//CHKSM=B9753824EAFDBC9D8DF6648032B43807356D3A8E