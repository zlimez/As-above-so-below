...
Shader "Sprite Shaders Ultimate/Standard/Fading/Full Glow Dissolve"
{
	Properties
	{
		...
		[ASEEnd]_FullGlowDissolveNoiseTexture("Full Glow Dissolve: Noise Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 texCoord2_g163 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord22_g163 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float3 ase_worldPos = IN.ase_texcoord2.xyz;
				float2 texCoord23_g163 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult28_g163 = (float2(_RectWidth , _RectHeight));
				float4 screenPos = IN.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				#if defined(_SHADERSPACE_UV)
				float2 staticSwitch1_g163 = ( texCoord2_g163 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#elif defined(_SHADERSPACE_UV_RAW)
				float2 staticSwitch1_g163 = texCoord22_g163;
				#elif defined(_SHADERSPACE_OBJECT)
				float2 staticSwitch1_g163 = (IN.ase_texcoord1.xyz).xy;
				#elif defined(_SHADERSPACE_OBJECT_SCALED)
				float2 staticSwitch1_g163 = ( (IN.ase_texcoord1.xyz).xy * (ase_objectScale).xy );
				#elif defined(_SHADERSPACE_WORLD)
				float2 staticSwitch1_g163 = (ase_worldPos).xy;
				#elif defined(_SHADERSPACE_UI_ELEMENT)
				float2 staticSwitch1_g163 = ( texCoord23_g163 * ( appendResult28_g163 / _PixelsPerUnit ) );
				#elif defined(_SHADERSPACE_SCREEN)
				float2 staticSwitch1_g163 = ( ( (ase_screenPosNorm).xy * (_ScreenParams).xy ) / ( _ScreenParams.x / _ScreenWidthUnits ) );
				#else
				float2 staticSwitch1_g163 = ( texCoord2_g163 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float temp_output_5_0_g153 = tex2D( _FullGlowDissolveNoiseTexture, ( staticSwitch1_g163 * _FullGlowDissolveNoiseScale ) ).r;
...
/*ASEBEGIN
Version=18900
105;432;1374;587;1712.206;443.2659;1.481326;True;True
...
Node;AmplifyShaderEditor.FunctionNode;87;-724.1623,-232.9176;Inherit;False;ShaderSpace;0;;163;be729ef05db9c224caec82a3516038dc;0;1;3;SAMPLER2D;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;85;-349.32,-216.5191;Inherit;False;_FullGlowDissolve;6;;153;8ddf4a66b5da487489c0831f7f85d466;0;3;73;FLOAT2;0,0;False;72;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
WireConnection;87;3;41;0
WireConnection;85;73;87;0
WireConnection;85;1;17;0
WireConnection;86;1;85;0
WireConnection;14;0;86;0
ASEEND*/
//CHKSM=CE5AB1E42C905C6543343835B06E239B54139739