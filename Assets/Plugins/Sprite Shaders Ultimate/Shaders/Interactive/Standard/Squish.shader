...
Shader "Sprite Shaders Ultimate/Standard/Interactive/Squish"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 break77_g112 = IN.texcoord.xy;
				float2 appendResult72_g112 = (float2(( _SquishStretch * ( break77_g112.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g112.y + _SquishFlip ) * -_SquishSquish )));
				
				
				IN.vertex.xyz += float3( appendResult72_g112 ,  0.0 ); 
...
/*ASEBEGIN
Version=18800
97;33;1338;724;2089.504;827.2561;1.965713;True;True
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;52;-1228.596,-322.3207;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C41A3D48891FDBDDE58CD522304705A131AB0D6B